<?php $__env->startSection('title', 'إدارة الطرد: ' . $batch->name); ?>
...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-4xl font-bold text-gray-900">إدارة الطرد: <?php echo e($batch->name); ?></h1>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        ...
        <?php if($batch->isDraft()): ?>
            <form action="<?php echo e(route('batches.update', $batch)); ?>" method="POST" class="space-y-4" id="batch-edit-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name', $batch->name)); ?>" required
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="type" required class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 <?php $__errorArgs = ['type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <option value="food" <?php echo e(old('type', $batch->type) === 'food' ? 'selected' : ''); ?>>غذائي</option>
                            <option value="health" <?php echo e(old('type', $batch->type) === 'health' ? 'selected' : ''); ?>>صحي</option>
                            <option value="clothes" <?php echo e(old('type', $batch->type) === 'clothes' ? 'selected' : ''); ?>>ملابس</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="quantity" value="<?php echo e(old('quantity', $batch->quantity ?? '')); ?>" required min="<?php echo e($batch->beneficiaries->count()); ?>"
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 <?php $__errorArgs = ['quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php if($batch->beneficiaries->count() > 0): ?>
                            <p class="mt-1 text-xs text-amber-600">الحد الأدنى: <?php echo e($batch->beneficiaries->count()); ?> (عدد المستفيدين الحاليين)</p>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="batch_date" value="<?php echo e(old('batch_date', $batch->batch_date ? $batch->batch_date->format('Y-m-d') : '')); ?>"
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 <?php $__errorArgs = ['batch_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" rows="3" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-emerald-500 <?php $__errorArgs = ['notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('notes', $batch->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-900"><?php echo e($batch->batch_date ? $batch->batch_date->format('Y-m-d') : '-'); ?></p>
                </div>
                <?php if($batch->notes): ?>
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-500 mb-1">ملاحظات</label>
                    <p class="text-gray-900"><?php echo e($batch->notes); ?></p>
                </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="text-sm text-gray-600">
                ...
                <span id="current-beneficiaries-count"><?php echo e($batch->beneficiaries->count()); ?></span> 
                / 
                <span class="font-semibold"><?php echo e($batch->quantity ?? 'غير محدد'); ?></span>
            </div>
        </div>
        
        <div class="flex flex-wrap gap-4">
            <!-- طريقة 1: اختيار من قائمة المستفيدين -->
            <a href="<?php echo e(route('beneficiaries.index', ['batch_id' => $batch->id])); ?>" 
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200" id="beneficiaries-table">
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="beneficiaries-table-body">
                    <?php $__empty_1 = true; $__currentLoopData = $batchBeneficiaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $beneficiary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="beneficiary-row" 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-600"><?php echo e($batchBeneficiaries->firstItem() + $index); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-medium text-gray-900"><?php echo e($beneficiary->name); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-600"><?php echo e($beneficiary->national_id ?? '-'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-600"><?php echo e($beneficiary->phone ?? '-'); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-600"><?php echo e($beneficiary->family_members_count + 1); ?></td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                <button type="button" onclick="removeBeneficiary(<?php echo e($beneficiary->id); ?>)" 
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="<?php echo e($batch->isDraft() ? '7' : '6'); ?>" class="px-6 py-12 text-center text-gray-500">
        ...
        <?php if($batchBeneficiaries->hasPages()): ?>
            <div class="px-6 py-4 border-t border-gray-200 mt-4">
                <div class="text-sm text-gray-600 text-center mb-2">
                    عرض <strong><?php echo e($batchBeneficiaries->firstItem() ?? 0); ?></strong> إلى <strong><?php echo e($batchBeneficiaries->lastItem() ?? 0); ?></strong> من <strong><?php echo e($batchBeneficiaries->total()); ?></strong>
                </div>
                <div class="flex items-center justify-center">
                    <?php echo e($batchBeneficiaries->onEachSide(1)->links()); ?>
...
function removeBeneficiary(beneficiaryId) {
    ...
    const url = `/batches/<?php echo e($batch->id); ?>/beneficiaries/${beneficiaryId}`;
    fetch(url, {
        method: 'DELETE',
        headers: {
...
uploadExcelBtn?.addEventListener('click', function() {
    ...
    fetch('<?php echo e(route("batches.import-excel-preview", $batch)); ?>', {
        method: 'POST',
        body: formData
    })
    .then(response => {
...
confirmExcelBtn?.addEventListener('click', function() {
    ...
    fetch('<?php echo e(route("batches.confirm-excel-import", $batch)); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\goodaid\resources\views/batches/manage.blade.php ENDPATH**/ ?>