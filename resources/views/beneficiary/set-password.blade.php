    ...
    <div class="max-w-md w-full mx-4">
        <div class="bg-white rounded-xl shadow-xl border border-emerald-300 p-10">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-gray-500 mt-2">مرحباً {{ $beneficiary->name }}</p>
                <p class="text-xs text-gray-400 mt-1">اسم المستخدم: <span class="font-semibold">{{ $beneficiary->username }}</span></p>
            </div>
            ...
            <form action="{{ route('beneficiary.set-password') }}" method="POST" class="space-y-6">
                @csrf
