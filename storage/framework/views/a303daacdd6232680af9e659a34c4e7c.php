...
<body class="bg-gradient-to-br from-emerald-50 to-teal-50 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full mx-4">
        <div class="bg-white rounded-xl shadow-xl border border-emerald-300 p-10">
            ...
            <form action="<?php echo e(route('beneficiary.verify')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\goodaid\resources\views/beneficiary/verify.blade.php ENDPATH**/ ?>