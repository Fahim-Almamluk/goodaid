<?php $__env->startSection('title', 'تعديل مستفيد'); ?>
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-10">
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-2 text-lg">تحديث بيانات المستفيد: <?php echo e($beneficiary->name); ?></p>
        </div>

        <form action="<?php echo e(route('beneficiaries.update', $beneficiary)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="national_id" id="national_id" value="<?php echo e(old('national_id', $beneficiary->national_id)); ?>"
                    class="w-full px-4 py-3.5 rounded-xl border-2 border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-base">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="3"
                    class="w-full px-4 py-3.5 rounded-xl border-2 border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-base"><?php echo e(old('notes', $beneficiary->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center">
                <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', $beneficiary->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\goodaid\resources\views/beneficiaries/edit.blade.php ENDPATH**/ ?>