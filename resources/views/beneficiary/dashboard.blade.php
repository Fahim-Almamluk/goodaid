        ...
        <div class="space-y-8">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-gray-900">{{ $beneficiary->name }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-gray-900">{{ $beneficiary->national_id ?? '-' }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-gray-900">{{ $beneficiary->batches ? $beneficiary->batches->count() : 0 }}</p>
                        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('beneficiary.profile') }}" class="px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl hover:shadow-lg transition-all font-semibold">
