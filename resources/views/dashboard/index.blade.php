...
<div class="space-y-8">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($stats['total_beneficiaries'] ?? 0) }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-600 mt-2">{{ number_format($stats['active_beneficiaries'] ?? 0) }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-600 mt-2">{{ number_format($stats['inactive_beneficiaries'] ?? 0) }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-600 mt-2">{{ number_format($stats['total_batches'] ?? 0) }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-yellow-600 mt-2">{{ number_format($stats['draft_batches'] ?? 0) }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-600 mt-2">{{ number_format($stats['active_batches'] ?? 0) }}</p>
                </div>
                <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                    <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-orange-600 mt-2">{{ number_format($stats['received_today'] ?? 0) }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-teal-600 mt-2">{{ number_format($stats['received_this_month'] ?? 0) }}</p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('batches.index') }}" class="text-emerald-600 hover:text-emerald-700 font-semibold">عرض الكل →</a>
        </div>
                    ...
                    @foreach($recentBatches as $batch)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-900">
                                <a href="{{ route('batches.manage', $batch) }}" class="text-emerald-600 hover:text-emerald-800 font-semibold">
                                    {{ $batch->name }}
                                </a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-600">{{ $batch->type_name ?? '-' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-600">{{ $batch->beneficiaries_count }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-600">{{ $batch->created_at->format('Y-m-d') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
