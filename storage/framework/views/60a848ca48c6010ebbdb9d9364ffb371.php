<?php $__env->startSection('title', 'إضافة مستفيد جديد'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-10">
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-900">إضافة مستفيد جديد</h1>
            <p class="text-gray-600 mt-2 text-lg">املأ البيانات التالية لإضافة مستفيد جديد</p>
        </div>

        <form action="<?php echo e(route('beneficiaries.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="md:col-span-2">
                ...
                <input type="number" name="number_of_members" id="number_of_members" value="<?php echo e(old('number_of_members', 1)); ?>" min="1" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="national_id" id="national_id" value="<?php echo e(old('national_id')); ?>" required
                    class="w-full px-4 py-3.5 rounded-xl border-2 border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-base">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select name="relationship" id="relationship" required
                    ...
                    <option value="زوج/ة" <?php echo e(old('relationship') === 'زوج/ة' ? 'selected' : ''); ?>>زوج/ة</option>
                    <option value="أرمل/ة" <?php echo e(old('relationship') === 'أرمل/ة' ? 'selected' : ''); ?>>أرمل/ة</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select name="residence_status" id="residence_status" required
                    class="w-full px-4 py-3.5 rounded-xl border-2 border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-base">
                    <option value="resident" <?php echo e(old('residence_status', 'resident') === 'resident' ? 'selected' : ''); ?>>مقيم</option>
                    <option value="displaced" <?php echo e(old('residence_status') === 'displaced' ? 'selected' : ''); ?>>نازح</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="3"
                    class="w-full px-4 py-3.5 rounded-xl border-2 border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-base"><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-end gap-4 pt-8 border-t border-gray-200">
                <a href="<?php echo e(route('beneficiaries.index')); ?>" class="px-5 py-2.5 bg-red-500 text-white rounded-xl hover:bg-red-600 hover:shadow-lg transition-all duration-200 text-sm font-semibold whitespace-nowrap">
                    إلغاء
                </a>
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            memberCard.innerHTML = `
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="family_members[${i}][name]" required
                    ...
                    <div>
                        ...
                        <input type="text" name="family_members[${i}][national_id]"
                            class="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-base">
                    </div>
                    <div>
                        <label class="block text-base font-semibold text-gray-700 mb-2">تاريخ الميلاد</label>
                        <input type="date" name="family_members[${i}][birth_date]"
                            class="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-base">
                    </div>
                    <div>
                        ...
                        <select name="family_members[${i}][relationship]" id="relationship_${i}"
                            ...
                            <option value="">اختر العلاقة</option>
                            ${relationships.map(rel => `<option value="${rel.value}">${rel.label}</option>`).join('')}
                        </select>
                    </div>
                    <div class="md:col-span-2 pregnancy-nursing-container" id="pregnancy_nursing_${i}" style="display: none;">
                        <div class="flex items-center space-x-6 space-x-reverse pt-2">
                            <div class="flex items-center">
                                <input type="checkbox" name="family_members[${i}][is_pregnant]" id="pregnant_${i}" value="1"
                                    class="w-4 h-4 text-emerald-600 border-gray-300 rounded focus:ring-emerald-500">
                                <label for="pregnant_${i}" class="mr-2 text-base font-medium text-gray-700">حامل</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" name="family_members[${i}][is_nursing]" id="nursing_${i}" value="1"
                                    class="w-4 h-4 text-emerald-600 border-gray-300 rounded focus:ring-emerald-500">
            ...
            const pregnancyContainer = memberCard.querySelector(`#pregnancy_nursing_${i}`);
                    ...
                    relationshipSelect.addEventListener('change', function() {
                        if (this.value === 'زوج/ة') {
                            ...
                            memberCard.querySelector(`#pregnant_${i}`).checked = false;
                            memberCard.querySelector(`#nursing_${i}`).checked = false;
                        }
                    });
    ...
    // عرض النماذج عند تحميل الصفحة إذا كان هناك قيم قديمة
    const oldCount = parseInt(numberInput.value) || 0;
    if (oldCount > 0) {
        renderFamilyMembersForms(oldCount);
    }
});
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\goodaid\resources\views/beneficiaries/create.blade.php ENDPATH**/ ?>