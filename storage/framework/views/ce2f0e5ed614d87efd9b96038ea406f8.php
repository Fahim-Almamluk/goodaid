    ...
    <div class="max-w-md w-full mx-4">
        <div class="bg-white rounded-xl shadow-xl border border-emerald-300 p-10">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-xl font-semibold text-gray-700">تسجيل الدخول</p>
            </div>
            ...
            <form action="<?php echo e(route('beneficiary.login')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>

                <div>
                    <label for="national_id" class="block text-sm font-medium text-gray-700 mb-2">رقم الهوية الوطنية</label>
                    <input type="text" name="national_id" id="national_id" value="<?php echo e(old('national_id')); ?>" 
            ...
            <div class="mt-6 text-center">
                <a href="<?php echo e(route('beneficiary.verify')); ?>" class="text-sm text-emerald-600 hover:text-emerald-700">
                    العودة للتحقق من الهوية
                </a>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\goodaid\resources\views/beneficiary/login.blade.php ENDPATH**/ ?>