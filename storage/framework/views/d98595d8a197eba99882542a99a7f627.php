...
<div class="space-y-8">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'users.create')): ?>
            <a href="<?php echo e(route('users.create')); ?>" class="px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all font-semibold">
                إضافة مستخدم جديد
            </a>
            <?php endif; ?>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $users ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-3 py-1 text-xs font-semibold rounded-full <?php echo e($user->role === 'admin' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'); ?>">
                                    <?php echo e($user->role === 'admin' ? 'مدير' : 'مستخدم'); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'users.edit')): ?>
                                    <a href="<?php echo e(route('users.edit', $user)); ?>" class="px-3 py-1.5 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition-all duration-200 text-xs font-semibold flex items-center gap-1.5">
                                    ...
                                    <?php endif; ?>
                                    <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'users.delete')): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\goodaid\resources\views/users/index.blade.php ENDPATH**/ ?>