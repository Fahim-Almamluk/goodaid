    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-10">
        ...
        <form action="{{ route('beneficiaries.store') }}" method="POST" class="space-y-6">
            ...
            <div class="md:col-span-2">
                ...
                <input type="number" name="number_of_members" id="number_of_members" value="{{ old('number_of_members', 1) }}" min="1" required
            ...
            <div>
                ...
                <select name="relationship" id="relationship" required
                    ...
                    <option value="زوج/ة" {{ old('relationship') === 'زوج/ة' ? 'selected' : '' }}>زوج/ة</option>
                    <option value="أرمل/ة" {{ old('relationship') === 'أرمل/ة' ? 'selected' : '' }}>أرمل/ة</option>
                </select>
                @error('relationship')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <select name="residence_status" id="residence_status" required
                    class="w-full px-4 py-3.5 rounded-xl border-2 border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-base">
                    <option value="resident" {{ old('residence_status', 'resident') === 'resident' ? 'selected' : '' }}>مقيم</option>
                    <option value="displaced" {{ old('residence_status') === 'displaced' ? 'selected' : '' }}>نازح</option>
                </select>
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="3"
                    class="w-full px-4 py-3.5 rounded-xl border-2 border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-base">{{ old('notes') }}</textarea>
                @error('notes')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
