...
<?php $__env->startSection('title', 'إدارة صلاحيات المستخدم'); ?>
                ...
                <div class="flex-1 w-full md:w-auto">
                    ...
                    <select name="user_id" id="user-select" class="w-full px-4 py-3.5 rounded-xl border-2 border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-base h-[48px]">
                        ...
                        <?php $__currentLoopData = $users ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($user->id); ?>" data-username="<?php echo e($user->username); ?>" data-name="<?php echo e($user->name); ?>">
                                <?php echo e($user->username); ?> - <?php echo e($user->name); ?>
...
<script src="<?php echo e(asset('js/user-permissions.js')); ?>"></script>
<script>
...
$(document).ready(function() {
    ...
    selectElement.select2({
        ...
        ajax: {
            url: '<?php echo e(route("admin.api.users")); ?>',
            dataType: 'json',
            delay: 300,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\goodaid\resources\views/admin/user-permissions/index.blade.php ENDPATH**/ ?>